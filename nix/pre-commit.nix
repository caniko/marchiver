{
  ...
  cargo-msrv = {
    ...
    entry = "${pkgs.coreutils}/bin/env CARGO_HOME=/tmp/marchiver-msrv-cargo CARGO_TARGET_DIR=target/msrv ${pkgs.rust-bin.stable."1.88.0".default}/bin/cargo check --workspace --all-features";
